...
{
    public class IsSuUniqeEditClientPropertyValidator : FluentValidationPropertyValidator
    {
        public IsSuUniqeEditClientPropertyValidator(ModelMetadata metadata, ControllerContext controllerContext, PropertyRule rule, IPropertyValidator validator)
        ...
        public override IEnumerable<ModelClientValidationRule> GetClientValidationRules()
        {
            ...
            rule.ValidationParameters.Add("url", Utils.API_PATH + "/api/Validation/IsSuUniqueEdit/{Id}");
