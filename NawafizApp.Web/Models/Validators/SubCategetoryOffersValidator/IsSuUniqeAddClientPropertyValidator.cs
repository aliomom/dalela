...
{
   public  class IsSuUniqeAddClientPropertyValidator : FluentValidationPropertyValidator
    {
        public IsSuUniqeAddClientPropertyValidator(ModelMetadata metadata, ControllerContext controllerContext, PropertyRule rule, IPropertyValidator validator)
        ...
        public override IEnumerable<ModelClientValidationRule> GetClientValidationRules()
        {
            ...
            rule.ValidationParameters.Add("url", Utils.API_PATH + "/api/Validation/IsSuUnique");
