...
{
    public class IsNumUniqeEditClientPropertyValidator : FluentValidationPropertyValidator
    {
        public IsNumUniqeEditClientPropertyValidator(ModelMetadata metadata, ControllerContext controllerContext, PropertyRule rule, IPropertyValidator validator)
        ...
        public override IEnumerable<ModelClientValidationRule> GetClientValidationRules()
        {
            ...
            rule.ValidationParameters.Add("url", Utils.API_PATH + "/api/Validation/IsNumUniqueEdit/{Id}");
